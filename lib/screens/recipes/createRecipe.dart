...
class _CreateRecipeState extends State<CreateRecipe> {
  ...
  Widget build(BuildContext context) {
    ...
    final _tabPages = <Widget>[
      Center(child: AddIngredient(_ingredients)),
      Center(child: AddInstruction(_instructions)),
    ];
    final _tabs = <Tab>[
            ...
            FlatButton.icon(
              ...
              onPressed: () {
                recipeDB.addCustomRecipe(new Recipe(
                    ...
                    rating: _rating,
                    numRatings: _numRatings)); // adds to all recipes and personal collection
              },
            ),
          ],
